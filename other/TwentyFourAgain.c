...
void iter_parentheses_1_0(int score, int aa, int bb, int cc, int dd, int o1, int o2){
    iter_operator(score, aa, bb, ANY, cc, o1, dd, o2); 
    iter_operator(score, aa, bb, o1, cc, o2, dd, ANY); 
    iter_operator(score, aa, bb, o1, cc, dd, ANY, o2); 
    iter_operator(score, aa, bb, cc, ANY, o1, dd, o2); 
    iter_operator(score, aa, bb, cc, o1, dd, o2, ANY); 
}
void iter_parentheses_1_1(int score, int aa, int bb, int cc, int dd, int o1, int o2) {
    iter_operator(score, aa, bb, ANY, cc, dd, o1, o2); 
    iter_operator(score, aa, bb, cc, o1, o2, dd, ANY); 
    iter_operator(score, aa, bb, cc, ANY, dd, o1, o2); 
    iter_operator(score, aa, bb, cc, dd, ANY, o1, o2); 
    iter_operator(score, aa, bb, cc, dd, o1, o2, ANY); 
}
void iter_parentheses_2(int score, int aa, int bb, int cc, int dd){
    iter_operator(score, aa, bb, ANY, cc, ANY, dd, ANY); 
    iter_operator(score, aa, bb, ANY, cc, dd, ANY, ANY); 
    iter_operator(score, aa, bb, cc, ANY, ANY, dd, ANY); 
    iter_operator(score, aa, bb, cc, ANY, dd, ANY, ANY); 
    iter_operator(score, aa, bb, cc, dd, ANY, ANY, ANY); 
}
